        ...
        <div class="col-lg-6 mb-4">
          <div class="card">
            ...
            <div class="card-body pt-0 pb-0">
                <form action="{{ route('dashboard-data-buku.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('isbn') is-invalid @enderror" type="number" id="isbn" name="isbn" value="{{ old('isbn') }}" required>
                        @error('isbn') <small class="invalid-feedback">{{ $message }}</small> @enderror
                    </div>
                    <div class="form-group">
                        <label for="author" class="form-control-label">Penulis</label>
                        <input class="form-control @error('author') is-invalid @enderror" type="text" id="author" name="author" value="{{ old('author') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('publisher') is-invalid @enderror" type="text" id="publisher" name="publisher" value="{{ old('publisher') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('published_at') is-invalid @enderror" type="date" id="published_at" name="published_at" value="{{ old('published_at') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('page_number') is-invalid @enderror" type="number" id="page_number" name="page_number" value="{{ old('page_number') }}" required>
                        @error('page_number') <small class="invalid-feedback">{{ $message }}</small> @enderror
                    </div>
                    <div class="form-group">
                      <label for="stock" class="form-control-label">Stock</label>
                      <input class="form-control @error('stock') is-invalid @enderror" type="number" id="stock" name="stock" value="{{ old('stock') }}" required>
                      @error('stock') <small class="invalid-feedback">{{ $message }}</small> @enderror
                    </div>
                    <div class="form-group">
                      <label for="synopsis">Sinopsis Buku</label>
                      <textarea class="form-control @error('synopsis') is-invalid @enderror" id="synopsis" name="synopsis" rows="3" required>{{ old('synopsis') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <img class="img-fluid img-preview mb-3" style="width: 100px;">
                        <input class="form-control @error('cover') is-invalid @enderror" type="file" id="cover" name="cover" required onchange="previewImage()">
