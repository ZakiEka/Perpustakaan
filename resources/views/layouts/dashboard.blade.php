...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('assets/flexstart/img/logo.png') }}">
  <link rel="icon" type="image/png" href="{{ asset('assets/flexstart/img/logo.png') }}">
  <title>
    MDP LIBRARY
  </title>
  <!--     Fonts and icons     -->
  ...
  <link href="{{ asset('assets/softui/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('assets/softui/css/soft-ui-dashboard.css') }}?v=1.0.7" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="{{ asset('assets/flexstart/img/logo.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">MDP Library</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link @if(Request::is('dashboard/mahasiswa*')) active @endif" href="{{ route('dashboard-mahasiswa.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @if(auth()->user()->role == 'admin')
        <li class="nav-item">
          <a class="nav-link @if(Request::is('dashboard/data-buku*')) active @endif" href="{{ Route('dashboard-data-buku.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @endif
        <li class="nav-item">
          <a class="nav-link @if(Request::is('dashboard/peminjaman-buku*')) active @endif" href="{{ Route('dashboard-peminjaman-buku.index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          ...
          <form method="POST" action="{{ route('logout') }}" class="nav-link p-0 m-0">
            @csrf
            <button style="background-color: inherit; border: 0px solid black;" type="submit" class="nav-link m-0 p-0">
          <a class="nav-link  ">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <script src="{{ asset('assets/softui/js/soft-ui-dashboard.min.js') }}?v=1.0.7"></script>
</body>
